...
int		CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wClassView.EnableDocking(CBRS_ALIGN_ANY);
	DockPane(&m_wFileView);
	CDockablePane* pTabbedBar = NULL;
	m_wClassView.AttachToTabWnd(&m_wFileView, DM_SHOW, TRUE, &pTabbedBar);
...
BOOL	CMainFrame::CreateDockingWindows()
{
	...
	ASSERT(bNameValid);
	if (!m_wClassView.Create(strClassView, this, CRect(0, 0, 200, 200), TRUE, 
	...
	ASSERT(bNameValid);
	if (!m_wFileView.Create(strFileView, this, CRect(0, 0, 200, 200), TRUE, 
...
void	CMainFrame::SetDockingWindowIcons(BOOL bHiColorIcons)
{
	...
	m_wClassView.SetIcon(hClassViewIcon, FALSE);
 ...
 * \return 
 */
BOOL	CMainFrame::AddLogMessage(LPCTSTR lpszMessage, COLORREF clr)
{
