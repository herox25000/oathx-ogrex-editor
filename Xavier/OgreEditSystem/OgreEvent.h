#ifndef _____OgreEvent_h_
#define _____OgreEvent_h_

#include "OgreBoundSlot.h"
#include "OgreSubscriberSlot.h"
#include "OgreRefCounted.h"
...
*/
class Ogre_EditSystem_Export_API Event
{
public:
    /*!
    \brief
        ...
        from the event.
    */
	typedef RefCounted<Ogre::BoundSlot> Connection;
