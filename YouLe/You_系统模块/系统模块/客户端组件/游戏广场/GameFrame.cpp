	...
	case ItemGenre_Inside:
		{
			...
			WebBrowse(TEXT("http://www.youle8.com"),false);
	...
	case ItemGenre_Kind:		//游戏类型
		{
			...
			_snprintf(szRuleUrl,sizeof(szRuleUrl),TEXT("http://www.youle8.com/GameRule.asp?KindID=%ld"),pGameKind->wKindID);
...
BOOL CGameFrame::OnCommand(WPARAM wParam, LPARAM lParam)
{
	...
	case IDC_BT_BUTTON_5:				//功能按钮
		{
			if(IDC_BT_BUTTON_1==nCommandID)WebBrowse(TEXT("http://www.youle8.com/FrameButton1.asp"),true);
			if(IDC_BT_BUTTON_3==nCommandID)WebBrowse(TEXT("http://www.youle8.com/FrameButton3.asp"),true);
			if(IDC_BT_BUTTON_4==nCommandID)WebBrowse(TEXT("http://www.youle8.com/FrameButton4.asp"),true);
			if(IDC_BT_BUTTON_5==nCommandID)WebBrowse(TEXT("http://www.youle8.com/FrameButton5.asp"),true);
...
void CGameFrame::ActivePlazaViewItem()
{
	...
	m_DlgGamePlaza.ShowWindow(SW_HIDE);
...
int CGameFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//m_BrowerAD.Navigate(TEXT("http://www.youle8.com/AD/GamePlazaAD.asp"),NULL,NULL,NULL,NULL);
