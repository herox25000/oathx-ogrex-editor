...
namespace Game.Web.Module.AppManager
{
    public partial class GameRoomInfoList : AdminPage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                aidePlatformFacade.DeleteGameRoomInfo(strQuery);
                ShowInfo("删除成功");
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = aidePlatformFacade.GetGameRoomInfoList(anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby);
