...
namespace Game.Web.Module.AppManager
{
    public partial class GameGameItemList : AdminPage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string strQuery = "WHERE GameID in (" + Checkbox_Value + ")";
            try
            {
                aidePlatformFacade.DeleteGameGameItem(strQuery);
                ShowInfo( "删除成功" );
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = aidePlatformFacade.GetGameGameItemList(anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby);
