    ...
    <div class="main" style="margin-top: 8px;">
        ...
        <div class="mainRight1">
            ...
            <div class="gameBanner">
                <div class="shopTitle bold bai f14">
                    道具商城</div>
                <div class="shopBg2">
                    <ul>
                        <li><span>
                            <img src="/img/prop_01.gif" /></span><label><a href="#" class="lh">双倍积分卡</a></label><label
                                class="Fline">原价格：1000</label><label class="cheng">会员价：900</label>
                            <label>
                                <img src="/images/buy.gif" />
                                <img src="/images/present.gif" width="33" height="18" /></label></li>
                        <li><span>
                            <img src="/img/prop_02.gif" width="90" height="90" /></span>
                            <label>
                                <a href="#" class="lh">四倍积分卡</a></label><label class="Fline">原价格：1000</label><label
                                    class="cheng">会员价：900</label>
                            <label>
                                <img src="/images/buy.gif" />
                                <img src="/images/present.gif" width="33" height="18" /></label></li>
                        <li><span>
                            <img src="/img/prop_03.gif" width="90" height="90" /></span>
                            <label>
                                <a href="#" class="lh">负分清零</a></label><label class="Fline">原价格：1000</label><label
                                    class="cheng">会员价：900</label>
                            <label>
                                <img src="/images/buy.gif" />
                                <img src="/images/present.gif" width="33" height="18" /></label></li>
                        <li><span>
                            <img src="/img/prop_04.gif" /></span><label><a href="#" class="lh">清逃跑率</a></label><label
                                class="Fline">原价格：1000</label><label class="cheng">会员价：900</label>
                            <label>
                                <img src="/images/buy.gif" />
                                <img src="/images/present.gif" width="33" height="18" /></label></li>
                        <li><span>
                            <img src="/img/prop_05.gif" /></span><label><a href="#" class="lh">小喇叭</a></label><label
                                class="Fline">原价格：1000</label><label class="cheng">会员价：900</label>
                            <label>
                                <img src="/images/buy.gif" />
                                <img src="/images/present.gif" width="33" height="18" /></label></li>
                        <li><span>
                            <img src="/img/prop_06.gif" /></span><label><a href="#" class="lh">防踢卡</a></label><label
                                class="Fline">原价格：1000</label><label class="cheng">会员价：900</label>
                            <label>
                                <img src="/images/buy.gif" />
                                <img src="/images/present.gif" width="33" height="18" /></label></li>
                        <li><span>
                            <img src="/img/prop_07.gif" /></span><label><a href="#" class="lh">护身符</a></label><label
                                class="Fline">原价格：1000</label><label class="cheng">会员价：900</label>
                            <label>
                                <img src="/images/buy.gif" />
                                <img src="/images/present.gif" width="33" height="18" /></label></li>
                        <li><span>
                            <img src="/img/prop_08.gif" /></span><label><a href="#" class="lh">红钻会员卡</a></label><label
                                class="Fline">原价格：1000</label><label class="cheng">会员价：900</label>
                            <label>
                                <img src="/images/buy.gif" />
                                <img src="/images/present.gif" width="33" height="18" /></label></li>
                        <li><span>
                            <img src="/img/prop_09.gif" /></span><label><a href="#" class="lh">蓝钻会员卡</a></label><label
                                class="Fline">原价格：1000</label><label class="cheng">会员价：900</label>
                            <label>
                                <img src="/images/buy.gif" />
                                <img src="/images/present.gif" width="33" height="18" /></label></li>
                        <li><span>
                            <img src="/img/prop_10.gif" /></span><label><a href="#" class="lh">黄钻会员卡</a></label><label
                                class="Fline">原价格：1000</label><label class="cheng">会员价：900</label>
                            <label>
                                <img src="/images/buy.gif" />
                                <img src="/images/present.gif" width="33" height="18" /></label></li>
                        <li><span>
                            <img src="/img/prop_11.gif" /></span><label><a href="#" class="lh">紫钻会员卡</a></label><label
                                class="Fline">原价格：1000</label><label class="cheng">会员价：900</label>
                            <label>
                                <img src="/images/buy.gif" />
                                <img src="/images/present.gif" width="33" height="18" /></label></li>
            ...
            <div class="gameBanner mtop10">
                ...
                <div class="shopBg2">
                    <ul>
                        <li><span>
                            <img src="/img/xw.gif" /></span><label><a href="#" class="lh">香吻</a></label><label
                        ...
                        <li><span>
                            <img src="/img/xh.gif" /></span>
                            <label>
                                <a href="#" class="lh">鲜花</a></label>
                            <label class="Fline">
                                原价格：1000</label><label class="cheng">会员价：900</label><label>魅力点：+1</label><label>魅力值：+1</label><label><img
                                    src="/images/viewInfo.gif" border="0" /></label>
                        </li>
                        <li><span>
                            <img src="/img/qc.gif" /></span>
                            <label>
                                <a href="#" class="lh">汽车</a></label>
                            <label class="Fline">
                                原价格：1000</label><label class="cheng">会员价：900</label><label>魅力点：+1</label><label>魅力值：+1</label><label><img
                                    src="/images/viewInfo.gif" border="0" /></label>
                        </li>
                        <li><span>
                            <img src="/img/gz.gif" width="90" height="90" /></span>
                            <label>
                                <a href="#" class="lh">鼓掌</a></label>
                            <label class="Fline">
                                原价格：1000</label><label class="cheng">会员价：900</label><label>魅力点：+1</label><label>魅力值：+1</label><label><img
                                    src="/images/viewInfo.gif" border="0" /></label>
                        </li>
