...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtServerDLLName" runat="server" CssClass="text" MaxLength="11"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
            ...
            <td>
                <asp:TextBox ID="txtClientExeName" runat="server" CssClass="text" MaxLength="11"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
