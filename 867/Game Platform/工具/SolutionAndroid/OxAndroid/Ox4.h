...
#define OX_FIVEKING					15									//天王牌型
	...
	// 牛牛机器人
	//////////////////////////////////////////////////////////////////////////
	class Ox4 : public IAndroid
	{
	public:
		// 构造函数
		Ox4(DWORD dwUserID, double fOnlineTime);
		// 析构函数
		virtual ~Ox4();
	...
	class Ox4Factory : public IAndroidFactroy
	{
	public:
		Ox4Factory(DWORD dwTypeID)
		...
		{
			return new Ox4(dwUserID, fOnlineTime);
		}
	};
}
