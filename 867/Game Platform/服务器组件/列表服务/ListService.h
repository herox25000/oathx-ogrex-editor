...
#include "..\..\开发库\Include\GlobalService.h"

//命令码文件
#include "..\..\开发库\Include\CMD_Game.h"
#include "..\..\开发库\Include\CMD_Plaza.h"
#include "..\..\开发库\Include\CMD_Center.h"

//组件头文件
#include "..\..\开发库\Include\KernelEngineHead.h"
...
//模块定义
#ifdef _DEBUG
	#define LIST_SERVICE_DLL_NAME	TEXT("plugin_listservice_d.dll")				//组件 DLL 名字
#else
	#define LIST_SERVICE_DLL_NAME	TEXT("plugin_listservice.dll")					//组件 DLL 名字
#endif
