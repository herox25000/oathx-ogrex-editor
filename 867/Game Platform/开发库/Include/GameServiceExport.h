...
//模块定义
#ifdef _DEBUG
	#define GAME_SERVICE_DLL_NAME	TEXT("plugin_gameservice_d.dll")				//组件 DLL 名字
#else
	#define GAME_SERVICE_DLL_NAME	TEXT("plugin_gameservice.dll")					//组件 DLL 名字
#endif
...
public:
	...
	//查询用户名
	virtual bool __cdecl QueryUserName(IServerUserItem * pIServerUserItem,long lGameID)=NULL;
