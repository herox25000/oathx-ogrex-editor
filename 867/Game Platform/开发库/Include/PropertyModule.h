...
#include "..\..\开发库\Include\NetworkServiceHead.h"
...
//模块定义
#ifdef _DEBUG
	#define PROPERTY_MODULE_DLL_NAME TEXT("plugin_property_d.dll")
#else
	#define PROPERTY_MODULE_DLL_NAME TEXT("plugin_property.dll")
#endif
