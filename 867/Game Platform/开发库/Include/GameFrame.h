...
//组件头文件
#include "..\..\开发库\Include\GameRank.h"
#include "..\..\开发库\Include\UserFace.h"
#include "..\..\开发库\Include\Companion.h"
#include "..\..\开发库\Include\ChannelModule.h"
#include "..\..\开发库\Include\ClientShare.h"
#include "..\..\开发库\Include\SkinControls.h"
#include "..\..\开发库\Include\SkinResourceModule.h"
...
//模块定义
#ifdef _DEBUG
	#define GAME_FRAME_DLL_NAME	TEXT("plugin_framework_d.dll")					//组件 DLL 名字
#else
	#define GAME_FRAME_DLL_NAME	TEXT("plugin_framework.dll")					//组件 DLL 名字
#endif
