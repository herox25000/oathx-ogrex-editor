...
//密码键盘
class SKIN_CONTROL_CLASS CPasswordKeyboard : public CDialog
{
	//配置变量
protected:
...
//密码编辑
class SKIN_CONTROL_CLASS CPasswordControl : public CWnd
{
	//友元定义
...
protected:
	...
	CSkinButtonEx					m_btKeyboard;						//键盘按钮
...
public:
	...
	//获取密码
	LPCTSTR GetUserPassword(TCHAR szPassword[PASS_LEN]);
