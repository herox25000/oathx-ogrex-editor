...
namespace Ogre
{
	...
	*/
	class TerrainEditor : public EditorPlugin, public FrameListener
	{
	public:
		/**
		 *
		 ...
		 * \return 
		 */
		TerrainEditor(const String& pluginName, float fMaxPixelError, uint16 nCompositeMapSize, float fCompositeMapDistance,
	...
	protected:
		 ...
		 * \param timePassed 
		 */
		virtual bool			optPaint(TerrainPageEditor* pPage, Vector3& vPos,
			float timePassed);
		 ...
		 * \return 
		 */
		virtual	bool			optSplat(TerrainPageEditor* pPage, Vector3& vPos,
			float timePassed);
		 ...
		 * \return 
		 */
		virtual	bool			optDeform(TerrainPageEditor* pPage, Vector3& vPos,
			float timePassed);
		 ...
		 * \return 
		 */
		virtual	bool			optSmooth(TerrainPageEditor* pPage, Vector3& vPos, float fAvg, float timePassed);
		 ...
		 * \param nSampleCount 
		 */
		virtual	void			calcSmoothingFactor(TerrainPageEditor* pPahe, Vector3&vPos,
	...
	// 地形创建适配参数
	struct STerrainEditorAdp : public SEditorPluginAdp
	{
	...
	* \Copyright (c) 2012 lp All rights reserved.
	*/
	class TerrrainEditorFactory : public EditorPluginFactory
	{
	public:
		/**
		 *
		 ...
		 * \return 
		 */
		TerrrainEditorFactory(const String& factoryName);

		/**
		 *
		 * \return 
		 */
		virtual ~TerrrainEditorFactory();
