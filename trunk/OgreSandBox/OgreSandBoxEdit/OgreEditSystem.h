...
namespace Ogre
{
	// editor factory register table
	typedef map<String, EditorFactory*>::type	EditorFactoryRegister;
	...
	*/
	...
	public:
		 ...
		 * \param pFactory 
		 */
		virtual	void				registerEditorFactory(EditorFactory* pFactory);
		 ...
		 * \return 
		 */
		virtual	EditorFactory*		getEditorFactory(const String& typeName);
		/**
		 *
		 * \param pFactory 
		 */
		virtual	void				unregisterEditorFactory(EditorFactory* pFactory);

	protected:
		SandBox*					m_pSandBox;
		EditorFactoryRegister		m_EditorFactoryRegister;
	};
}
