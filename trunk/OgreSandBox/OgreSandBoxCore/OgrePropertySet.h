...
namespace Ogre
{
	...
	*
	*/
	class Ogre_SandBox_Export_API PropertyEventArgs : public EventArgs
	{
	public:
		/**
		 *
	...
	*
	*/
	class Ogre_SandBox_Export_API PropertySet : public EventSet
	{
	public:
	...
	public:
		...
		void						getPropertyValue(const String& name, T& anyValue)
		{
			...
			{
				LogManager::getSingleton().logMessage("error: can't find property " + name, LML_CRITICAL);
			}
		}
