...
#define SMALLNINE_CFG_FILENAME	"./30Mini.cfg"
...
BOOL CConfigDialog::OnInitDialog()
{
	...
	if (!bResult)
	{
		...
		SetDlgItemText(IDC_EDIT4,	"441");
		SetDlgItemText(IDC_EDIT5,	"640");
		...
		SetDlgItemText(IDC_EDIT17,	"40");
		SetDlgItemText(IDC_EDIT18,	"8");
		SetDlgItemText(IDC_EDIT19,	"40");
		SetDlgItemText(IDC_EDIT20,	"2");
		SetDlgItemText(IDC_EDIT21,	"2");
		SetDlgItemText(IDC_EDIT22,	"1");

		SetDlgItemText(IDC_EDIT23,	"20");
