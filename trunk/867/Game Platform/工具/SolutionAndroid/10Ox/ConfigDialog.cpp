...
#define SMALLNINE_CFG_FILENAME	"./100NN.cfg"
...
BOOL CConfigDialog::OnInitDialog()
{
	...
	if (!bResult)
	{
		...
		SetDlgItemText(IDC_EDIT2,	"11041");
		SetDlgItemText(IDC_EDIT3,	"d746e3733dff946b0db30eb3fb0069c4");
		SetDlgItemText(IDC_EDIT4,	"671");
		SetDlgItemText(IDC_EDIT5,	"870");
		...
		SetDlgItemText(IDC_EDIT15,	"120000000");
		SetDlgItemText(IDC_EDIT16,	"2");
		SetDlgItemText(IDC_EDIT17,  "5");
		SetDlgItemText(IDC_EDIT18,	"14");
		SetDlgItemText(IDC_EDIT19,  "30");
		SetDlgItemText(IDC_EDIT20,  "10");
	}
	else
	{
		OnLoadConfig();
