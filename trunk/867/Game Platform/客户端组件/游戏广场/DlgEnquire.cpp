...
BOOL CDlgEnquire::OnInitDialog()
{
	...
	//功能按钮
	m_btSwitchAccounts.SetWindowPos(NULL,30,SizeWindow.cy-rcButton.Height()-30,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
	m_btClosePlaza.SetWindowPos(NULL,SizeWindow.cx-rcButton.Width()-30,SizeWindow.cy-rcButton.Height()-30,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
