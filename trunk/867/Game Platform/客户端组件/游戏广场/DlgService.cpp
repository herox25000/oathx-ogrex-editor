...
BEGIN_MESSAGE_MAP(CDlgService, CSkinPngDialog)
END_MESSAGE_MAP()
...
//构造函数
CDlgService::CDlgService() : CSkinPngDialog(IDD_DLG_SERVICE)
{
	//设置变量
	m_cbServiceID=0;
...
BOOL CDlgService::OnInitDialog()
{
	...
	m_DlgServiceBar.InsertServiceItem(&m_DlgServiceBrowser7);
	//设置地址
	m_DlgServiceBrowser1.InitService(5,TEXT("银行记录"),TEXT("UserService/UserService1.asp"));
	m_DlgServiceBrowser2.InitService(6,TEXT("游戏记录"),TEXT("UserService/UserService2.asp"));
	m_DlgServiceBrowser3.InitService(6,TEXT("充值记录"),TEXT("UserService/UserService3.asp"));
	m_DlgServiceBrowser4.InitService(7,TEXT("会员充值"),TEXT("UserService/UserService4.asp"));
	m_DlgServiceBrowser5.InitService(8,TEXT("负分清理"),TEXT("UserService/UserService5.asp"));
	m_DlgServiceBrowser6.InitService(9,TEXT("清逃跑率"),TEXT("UserService/UserService6.asp"));
	m_DlgServiceBrowser7.InitService(10,TEXT("游戏会员"),TEXT("UserService/UserService7.asp"));
