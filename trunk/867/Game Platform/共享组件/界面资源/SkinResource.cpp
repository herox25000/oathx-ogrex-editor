...
//获取信息
bool __cdecl CSkinResource::GetResourceInfo(tagSkinEditResource & SkinEditResource, CImageMap *pImageMap)
{
	//变量定义
...
//获取信息
bool __cdecl CSkinResource::GetResourceInfo(tagSkinDialogResource & SkinDialogResource, CImageMap *pImageMap)
{
	//变量定义
	HINSTANCE hInstance=GetModuleHandle(SKIN_RESOURCE_DLL_NAME);
	...
	if (CSkinImage::ms_pImageMap)
	{
		CSkinImage::ms_pImageMap->AddImage(DEF_IDB_SKIN_WND_TL, RES_DEF_IDB_SKIN_WND_TL);
		CSkinImage::ms_pImageMap->AddImage(DEF_IDB_SKIN_WND_TM, RES_DEF_IDB_SKIN_WND_TM);
		CSkinImage::ms_pImageMap->AddImage(DEF_IDB_SKIN_WND_TR, RES_DEF_IDB_SKIN_WND_TR);
	}
	...
	if (CSkinImage::ms_pImageMap)
	{
		CSkinImage::ms_pImageMap->AddImage(DEF_IDB_SKIN_WND_MIN, RES_DEF_IDB_SKIN_WND_MIN);
		CSkinImage::ms_pImageMap->AddImage(DEF_IDB_SKIN_WND_MAX, RES_DEF_IDB_SKIN_WND_MAX);
		CSkinImage::ms_pImageMap->AddImage(DEF_IDB_SKIN_WND_RESORE, RES_DEF_IDB_SKIN_WND_RESORE);
		CSkinImage::ms_pImageMap->AddImage(DEF_IDB_SKIN_WND_CLOSE, RES_DEF_IDB_SKIN_WND_CLOSE);
	}
...
//获取信息
bool __cdecl CSkinResource::GetResourceInfo(tagSkinButtonResource & SkinButtonResource, CImageMap *pImageMap)
{
	//变量定义
	HINSTANCE hInstance=GetModuleHandle(SKIN_RESOURCE_DLL_NAME);
	...
	if (CSkinImage::ms_pImageMap)
	{
		CSkinImage::ms_pImageMap->AddImage(DEF_IDB_SKIN_BUTTON_BACK, RES_DEF_IDB_SKIN_BUTTON_BACK);
	}
...
//获取信息
bool __cdecl CSkinResource::GetResourceInfo(tagSkinSplitterResource & SkinSplitterResource, CImageMap *pImageMap)
{
	//变量定义
	HINSTANCE hInstance=GetModuleHandle(SKIN_RESOURCE_DLL_NAME);
	...
	if (CSkinImage::ms_pImageMap)
	{
		CSkinImage::ms_pImageMap->AddImage(DEF_IDB_SKIN_SPLITTER_VOR, RES_DEF_IDB_SKIN_SPLITTER_VOR);
		CSkinImage::ms_pImageMap->AddImage(DEF_IDB_SKIN_SPLITTER_HOR, RES_DEF_IDB_SKIN_SPLITTER_HOR);
	}
	return true;
}

//获取信息
bool __cdecl CSkinResource::GetResourceInfo(tagSkinListCtrlResource & SkinListCtrlResource, CImageMap *pImageMap)
{
	//变量定义
	HINSTANCE hInstance=GetModuleHandle(SKIN_RESOURCE_DLL_NAME);
	...
	if (CSkinImage::ms_pImageMap)
	{
		CSkinImage::ms_pImageMap->AddImage(DEF_IDB_SKIN_HEAD_TITLE, RES_DEF_IDB_SKIN_HEAD_TITLE);
	}
	return true;
}

//获取信息
bool __cdecl CSkinResource::GetResourceInfo(tagSkinHyperLinkResource & SkinHyperLinkResource, CImageMap *pImageMap)
{
	switch(m_cbResourceType)
	{
	case RESOURCE_DEFAULT:
