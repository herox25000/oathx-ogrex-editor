...
bool __cdecl CPlatformResource::GetPlazaViewImage(tagPlazaViewImage * PlazaViewImage)
{
	...
	//CImageMap::Instance().AddImage(DEF_IDB_BROWSE_ML, "abc");
	...
	case RESOURCE_DEFAULT:
		{
			...
			m_pImageMap->AddImage(DEF_IDB_BROWSE_ML, RES_DEF_IDB_BROWSE_ML);
			m_pImageMap->AddImage(DEF_IDB_BROWSE_MR, RES_DEF_IDB_BROWSE_MR);
			m_pImageMap->AddImage(DEF_IDB_BROWSE_TL, RES_DEF_IDB_BROWSE_TL);
			m_pImageMap->AddImage(DEF_IDB_BROWSE_TM, RES_DEF_IDB_BROWSE_TM);
			m_pImageMap->AddImage(DEF_IDB_BROWSE_TR, RES_DEF_IDB_BROWSE_TR);
			m_pImageMap->AddImage(DEF_IDB_BROWSE_BL, RES_DEF_IDB_BROWSE_BL);
			m_pImageMap->AddImage(DEF_IDB_BROWSE_BM, RES_DEF_IDB_BROWSE_BM);
			m_pImageMap->AddImage(DEF_IDB_BROWSE_BR, RES_DEF_IDB_BROWSE_BR);
			...
			m_pImageMap->AddImage(DEF_IDB_BT_WEB_LAST, RES_DEF_IDB_BT_WEB_LAST);
			m_pImageMap->AddImage(DEF_IDB_BT_WEB_NEXT, RES_DEF_IDB_BT_WEB_NEXT);
			m_pImageMap->AddImage(DEF_IDB_BT_WEB_STOP, RES_DEF_IDB_BT_WEB_STOP);
			m_pImageMap->AddImage(DEF_IDB_BT_WEB_HOME, RES_DEF_IDB_BT_WEB_HOME);
			m_pImageMap->AddImage(DEF_IDB_BT_WEB_RELOAD, RES_DEF_IDB_BT_WEB_RELOAD);
	...
	case RESOURCE_BLACK:
		{
			...
			m_pImageMap->AddImage(BLACK_IDB_BROWSE_ML, RES_BLACK_IDB_BROWSE_ML);
			m_pImageMap->AddImage(BLACK_IDB_BROWSE_MR, RES_BLACK_IDB_BROWSE_MR);
			m_pImageMap->AddImage(BLACK_IDB_BROWSE_TL, RES_BLACK_IDB_BROWSE_TL);
			m_pImageMap->AddImage(BLACK_IDB_BROWSE_TM, RES_BLACK_IDB_BROWSE_TM);
			m_pImageMap->AddImage(BLACK_IDB_BROWSE_TR, RES_BLACK_IDB_BROWSE_TR);
			m_pImageMap->AddImage(BLACK_IDB_BROWSE_BL, RES_BLACK_IDB_BROWSE_BL);
			m_pImageMap->AddImage(BLACK_IDB_BROWSE_BM, RES_BLACK_IDB_BROWSE_BM);
			m_pImageMap->AddImage(BLACK_IDB_BROWSE_BR, RES_BLACK_IDB_BROWSE_BR);
			...
			m_pImageMap->AddImage(BLACK_IDB_BT_WEB_LAST, RES_BLACK_IDB_BT_WEB_LAST);
			m_pImageMap->AddImage(BLACK_IDB_BT_WEB_NEXT, RES_BLACK_IDB_BT_WEB_NEXT);
			m_pImageMap->AddImage(BLACK_IDB_BT_WEB_STOP, RES_BLACK_IDB_BT_WEB_STOP);
			m_pImageMap->AddImage(BLACK_IDB_BT_WEB_HOME, RES_BLACK_IDB_BT_WEB_HOME);
			m_pImageMap->AddImage(BLACK_IDB_BT_WEB_RELOAD, RES_BLACK_IDB_BT_WEB_RELOAD);
			break;
		}
	case RESOURCE_RED:
		{
			...
			m_pImageMap->AddImage(RED_IDB_BROWSE_ML, RES_RED_IDB_BROWSE_ML);
			m_pImageMap->AddImage(RED_IDB_BROWSE_MR, RES_RED_IDB_BROWSE_MR);
			m_pImageMap->AddImage(RED_IDB_BROWSE_TL, RES_RED_IDB_BROWSE_TL);
			m_pImageMap->AddImage(RED_IDB_BROWSE_TM, RES_RED_IDB_BROWSE_TM);
			m_pImageMap->AddImage(RED_IDB_BROWSE_TR, RES_RED_IDB_BROWSE_TR);
			m_pImageMap->AddImage(RED_IDB_BROWSE_BL, RES_RED_IDB_BROWSE_BL);
			m_pImageMap->AddImage(RED_IDB_BROWSE_BM, RES_RED_IDB_BROWSE_BM);
			m_pImageMap->AddImage(RED_IDB_BROWSE_BR, RES_RED_IDB_BROWSE_BR);
			...
			m_pImageMap->AddImage(RED_IDB_BT_WEB_LAST, RES_RED_IDB_BT_WEB_LAST);
			m_pImageMap->AddImage(RED_IDB_BT_WEB_NEXT, RES_RED_IDB_BT_WEB_NEXT);
			m_pImageMap->AddImage(RED_IDB_BT_WEB_STOP, RES_RED_IDB_BT_WEB_STOP);
			m_pImageMap->AddImage(RED_IDB_BT_WEB_HOME, RES_RED_IDB_BT_WEB_HOME);
			m_pImageMap->AddImage(RED_IDB_BT_WEB_RELOAD, RES_RED_IDB_BT_WEB_RELOAD);
			break;
		}
	}
...
bool __cdecl CPlatformResource::GetServerViewImage(tagServerViewImage * ServerViewImage)
{
	...
	m_pImageMap->AddImage(DEF_IDB_CHAT_ML, RES_DEF_IDB_CHAT_ML);
	m_pImageMap->AddImage(DEF_IDB_CHAT_MR, RES_DEF_IDB_CHAT_MR);
	m_pImageMap->AddImage(DEF_IDB_CHAT_TL, RES_DEF_IDB_CHAT_TL);
	m_pImageMap->AddImage(DEF_IDB_CHAT_TM, RES_DEF_IDB_CHAT_TM);
	m_pImageMap->AddImage(DEF_IDB_CHAT_TR, RES_DEF_IDB_CHAT_TR);
	m_pImageMap->AddImage(DEF_IDB_CHAT_BL, RES_DEF_IDB_CHAT_BL);
	m_pImageMap->AddImage(DEF_IDB_CHAT_BM, RES_DEF_IDB_CHAT_BM);
	m_pImageMap->AddImage(DEF_IDB_CHAT_BR, RES_DEF_IDB_CHAT_BR);
	...
	m_pImageMap->AddImage(DEF_IDB_TABLE_ML, RES_DEF_IDB_TABLE_ML);
	m_pImageMap->AddImage(DEF_IDB_TABLE_MR, RES_DEF_IDB_TABLE_MR);
	m_pImageMap->AddImage(DEF_IDB_TABLE_TL, RES_DEF_IDB_TABLE_TL);
	m_pImageMap->AddImage(DEF_IDB_TABLE_TM, RES_DEF_IDB_TABLE_TM);
	m_pImageMap->AddImage(DEF_IDB_TABLE_TR, RES_DEF_IDB_TABLE_TR);
	m_pImageMap->AddImage(DEF_IDB_TABLE_BL, RES_DEF_IDB_TABLE_BL);
	m_pImageMap->AddImage(DEF_IDB_TABLE_BM, RES_DEF_IDB_TABLE_BM);
	m_pImageMap->AddImage(DEF_IDB_TABLE_BR, RES_DEF_IDB_TABLE_BR);
	...
	m_pImageMap->AddImage(DEF_IDB_USER_LIST_ML, RES_DEF_IDB_USER_LIST_ML);
	m_pImageMap->AddImage(DEF_IDB_USER_LIST_MR, RES_DEF_IDB_USER_LIST_MR);
	m_pImageMap->AddImage(DEF_IDB_USER_LIST_TL, RES_DEF_IDB_USER_LIST_TL);
	m_pImageMap->AddImage(DEF_IDB_USER_LIST_TM, RES_DEF_IDB_USER_LIST_TM);
	m_pImageMap->AddImage(DEF_IDB_USER_LIST_TR, RES_DEF_IDB_USER_LIST_TR);
	m_pImageMap->AddImage(DEF_IDB_USER_LIST_BL, RES_DEF_IDB_USER_LIST_BL);
	m_pImageMap->AddImage(DEF_IDB_USER_LIST_BM, RES_DEF_IDB_USER_LIST_BM);
	m_pImageMap->AddImage(DEF_IDB_USER_LIST_BR, RES_DEF_IDB_USER_LIST_BR);
	...
	m_pImageMap->AddImage(DEF_IDB_BT_BUGLE, RES_DEF_IDB_BT_BUGLE);
	m_pImageMap->AddImage(DEF_IDB_BT_COLOR_SET, RES_DEF_IDB_BT_COLOR_SET);
	m_pImageMap->AddImage(DEF_IDB_BT_EXPESSION, RES_DEF_IDB_BT_EXPESSION);
	m_pImageMap->AddImage(DEF_IDB_BT_SEND_CHAT, RES_DEF_IDB_BT_SEND_CHAT);
	...
	m_pImageMap->AddImage(DEF_IDB_BT_BANK, RES_DEF_IDB_BT_BANK);

	//切换按钮
	ServerViewImage->uBtShowUserList=DEF_IDB_SHOW_USER_LIST;
	ServerViewImage->uBtHideUserList=DEF_IDB_HIDE_USER_LIST;
	m_pImageMap->AddImage(DEF_IDB_SHOW_USER_LIST, RES_DEF_IDB_SHOW_USER_LIST);
	m_pImageMap->AddImage(DEF_IDB_HIDE_USER_LIST, RES_DEF_IDB_HIDE_USER_LIST);
...
bool __cdecl CPlatformResource::GetPlatformFrameImage(tagPlatformFrameImage * PlatformFrameImage)
{
	...
	m_pImageMap->AddImage(DEF_IDB_FRAME_ML, RES_DEF_IDB_FRAME_ML);
	m_pImageMap->AddImage(DEF_IDB_FRAME_MR, RES_DEF_IDB_FRAME_MR);
	m_pImageMap->AddImage(DEF_IDB_FRAME_TL, RES_DEF_IDB_FRAME_TL);
	m_pImageMap->AddImage(DEF_IDB_FRAME_TM, RES_DEF_IDB_FRAME_TM);
	m_pImageMap->AddImage(DEF_IDB_FRAME_TR, RES_DEF_IDB_FRAME_TR);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BL, RES_DEF_IDB_FRAME_BL);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BM, RES_DEF_IDB_FRAME_BM);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BR, RES_DEF_IDB_FRAME_BR);
	...
	m_pImageMap->AddImage(DEF_IDB_SERVER_ML, RES_DEF_IDB_SERVER_ML);
	m_pImageMap->AddImage(DEF_IDB_SERVER_MR, RES_DEF_IDB_SERVER_MR);
	m_pImageMap->AddImage(DEF_IDB_SERVER_TL, RES_DEF_IDB_SERVER_TL);
	m_pImageMap->AddImage(DEF_IDB_SERVER_TM, RES_DEF_IDB_SERVER_TM);
	m_pImageMap->AddImage(DEF_IDB_SERVER_TR, RES_DEF_IDB_SERVER_TR);
	m_pImageMap->AddImage(DEF_IDB_SERVER_BL, RES_DEF_IDB_SERVER_BL);
	m_pImageMap->AddImage(DEF_IDB_SERVER_BM, RES_DEF_IDB_SERVER_BM);
	m_pImageMap->AddImage(DEF_IDB_SERVER_BR, RES_DEF_IDB_SERVER_BR);
	...
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_MIN, RES_DEF_IDB_FRAME_BT_MIN);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_CLOSE, RES_DEF_IDB_FRAME_BT_CLOSE);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_MAX, RES_DEF_IDB_FRAME_BT_MAX);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_RESORE, RES_DEF_IDB_FRAME_BT_RESORE);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_SELF_SET, RES_DEF_IDB_FRAME_BT_SELF_SET);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_SWITCH, RES_DEF_IDB_FRAME_BT_SWITCH);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_OPTION, RES_DEF_IDB_FRAME_BT_OPTION);
	m_pImageMap->AddImage(DEF_IDB_SERVER_BT_HIDE_1, RES_DEF_IDB_SERVER_BT_HIDE_1);
	m_pImageMap->AddImage(DEF_IDB_SERVER_BT_HIDE_2, RES_DEF_IDB_SERVER_BT_HIDE_2);
	m_pImageMap->AddImage(DEF_IDB_SERVER_BT_SHOW_1, RES_DEF_IDB_SERVER_BT_SHOW_1);
	m_pImageMap->AddImage(DEF_IDB_SERVER_BT_SHOW_2, RES_DEF_IDB_SERVER_BT_SHOW_2);
	...
	m_pImageMap->AddImage(DEF_IDB_SHOW_GAME_LIST, RES_DEF_IDB_SHOW_GAME_LIST);
	m_pImageMap->AddImage(DEF_IDB_HIDE_GAME_LIST, RES_DEF_IDB_HIDE_GAME_LIST);
	m_pImageMap->AddImage(DEF_IDB_BT_ITEM_NORMAL, RES_DEF_IDB_BT_ITEM_NORMAL);
	m_pImageMap->AddImage(DEF_IDB_BT_ITEM_AVTIVE, RES_DEF_IDB_BT_ITEM_AVTIVE);
	...
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_NAVIGATION_1, RES_DEF_IDB_FRAME_BT_NAVIGATION_1);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_NAVIGATION_2, RES_DEF_IDB_FRAME_BT_NAVIGATION_2);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_NAVIGATION_3, RES_DEF_IDB_FRAME_BT_NAVIGATION_3);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_NAVIGATION_4, RES_DEF_IDB_FRAME_BT_NAVIGATION_4);
	m_pImageMap->AddImage(DEF_IDB_FRAME_BT_NAVIGATION_5, RES_DEF_IDB_FRAME_BT_NAVIGATION_5);
...
bool __cdecl CPlatformResource::GetWhisperViewImage(tagWhisperViewImage * WhisperViewImage)
{
	...
	m_pImageMap->AddImage(DEF_IDB_CHAT_WHISPER_ML, RES_DEF_IDB_CHAT_WHISPER_ML);
	m_pImageMap->AddImage(DEF_IDB_CHAT_WHISPER_MR, RES_DEF_IDB_CHAT_WHISPER_MR);
	m_pImageMap->AddImage(DEF_IDB_CHAT_WHISPER_TL, RES_DEF_IDB_CHAT_WHISPER_TL);
	m_pImageMap->AddImage(DEF_IDB_CHAT_WHISPER_TM, RES_DEF_IDB_CHAT_WHISPER_TM);
	m_pImageMap->AddImage(DEF_IDB_CHAT_WHISPER_TR, RES_DEF_IDB_CHAT_WHISPER_TR);
	m_pImageMap->AddImage(DEF_IDB_CHAT_WHISPER_BL, RES_DEF_IDB_CHAT_WHISPER_BL);
	m_pImageMap->AddImage(DEF_IDB_CHAT_WHISPER_BM, RES_DEF_IDB_CHAT_WHISPER_BM);
	m_pImageMap->AddImage(DEF_IDB_CHAT_WHISPER_BR, RES_DEF_IDB_CHAT_WHISPER_BR);
	...
	m_pImageMap->AddImage(DEF_IDB_USER_WHISPER_ML, RES_DEF_IDB_USER_WHISPER_ML);
	m_pImageMap->AddImage(DEF_IDB_USER_WHISPER_MR, RES_DEF_IDB_USER_WHISPER_MR);
	m_pImageMap->AddImage(DEF_IDB_USER_WHISPER_TL, RES_DEF_IDB_USER_WHISPER_TL);
	m_pImageMap->AddImage(DEF_IDB_USER_WHISPER_TM, RES_DEF_IDB_USER_WHISPER_TM);
	m_pImageMap->AddImage(DEF_IDB_USER_WHISPER_TR, RES_DEF_IDB_USER_WHISPER_TR);
	m_pImageMap->AddImage(DEF_IDB_USER_WHISPER_BL, RES_DEF_IDB_USER_WHISPER_BL);
	m_pImageMap->AddImage(DEF_IDB_USER_WHISPER_BM, RES_DEF_IDB_USER_WHISPER_BM);
	m_pImageMap->AddImage(DEF_IDB_USER_WHISPER_BR, RES_DEF_IDB_USER_WHISPER_BR);
	...
	m_pImageMap->AddImage(DEF_IDB_INPUT_WHISPER_ML, RES_DEF_IDB_INPUT_WHISPER_ML);
	m_pImageMap->AddImage(DEF_IDB_INPUT_WHISPER_MR, RES_DEF_IDB_INPUT_WHISPER_MR);
	m_pImageMap->AddImage(DEF_IDB_INPUT_WHISPER_TL, RES_DEF_IDB_INPUT_WHISPER_TL);
	m_pImageMap->AddImage(DEF_IDB_INPUT_WHISPER_TM, RES_DEF_IDB_INPUT_WHISPER_TM);
	m_pImageMap->AddImage(DEF_IDB_INPUT_WHISPER_TR, RES_DEF_IDB_INPUT_WHISPER_TR);
	m_pImageMap->AddImage(DEF_IDB_INPUT_WHISPER_BL, RES_DEF_IDB_INPUT_WHISPER_BL);
	m_pImageMap->AddImage(DEF_IDB_INPUT_WHISPER_BM, RES_DEF_IDB_INPUT_WHISPER_BM);
	m_pImageMap->AddImage(DEF_IDB_INPUT_WHISPER_BR, RES_DEF_IDB_INPUT_WHISPER_BR);
	...
	m_pImageMap->AddImage(DEF_IDB_BT_WHISPER_ADD_USER, RES_DEF_IDB_BT_WHISPER_ADD_USER);
	m_pImageMap->AddImage(DEF_IDB_BT_WHISPER_COLOR_SET, RES_DEF_IDB_BT_WHISPER_COLOR_SET);
	m_pImageMap->AddImage(DEF_IDB_BT_WHISPER_LEAVE_CHAT, RES_DEF_IDB_BT_WHISPER_LEAVE_CHAT);
	m_pImageMap->AddImage(DEF_IDB_BT_WHISPER_EXPESSION, RES_DEF_IDB_BT_WHISPER_EXPESSION);
	m_pImageMap->AddImage(DEF_IDB_BT_WHISPER_CLEAN_SCREEN, RES_DEF_IDB_BT_WHISPER_CLEAN_SCREEN);
	m_pImageMap->AddImage(DEF_IDB_BT_WHISPER_MORE_FUNCTION, RES_DEF_IDB_BT_WHISPER_MORE_FUNCTION);

	//控制按钮
	WhisperViewImage->uBtWhisper=DEF_IDB_BT_WHISPER;
	WhisperViewImage->uBtSendControl=DEF_IDB_BT_WHISPER_SEND_CONTROL;
	m_pImageMap->AddImage(DEF_IDB_BT_WHISPER, RES_DEF_IDB_BT_WHISPER);
	m_pImageMap->AddImage(DEF_IDB_BT_WHISPER_SEND_CONTROL, RES_DEF_IDB_BT_WHISPER_SEND_CONTROL);

	//其他资源
	WhisperViewImage->uChatSplitter=DEF_IDB_WHISPER_SPLITTER_CHAT;
	m_pImageMap->AddImage(DEF_IDB_WHISPER_SPLITTER_CHAT, RES_DEF_IDB_WHISPER_SPLITTER_CHAT);
...
bool __cdecl CPlatformResource::GetControlViewImage(tagControlViewImage * ControlViewImage)
{
	...
	m_pImageMap->AddImage(DEF_IDB_USER_INFO_L, RES_DEF_IDB_USER_INFO_L);
	m_pImageMap->AddImage(DEF_IDB_USER_INFO_M, RES_DEF_IDB_USER_INFO_M);
	m_pImageMap->AddImage(DEF_IDB_USER_INFO_R, RES_DEF_IDB_USER_INFO_R);
	...
	m_pImageMap->AddImage(DEF_IDB_BAR_OP_ACTIVE, RES_DEF_IDB_BAR_OP_ACTIVE);
	m_pImageMap->AddImage(DEF_IDB_BAR_OP_BACKGROUND, RES_DEF_IDB_BAR_OP_BACKGROUND);
	m_pImageMap->AddImage(DEF_IDB_BAR_OP_HOT, RES_DEF_IDB_BAR_OP_HOT);
	m_pImageMap->AddImage(DEF_IDB_BAR_OP_NORMAL, RES_DEF_IDB_BAR_OP_NORMAL);
...
bool __cdecl CPlatformResource::GetPropertyViewImage(tagPropertyViewImage * PropertyViewImage)
{
	...
	m_pImageMap->AddImage(DEF_IDB_BT_BUGLE_EXPESSION, RES_DEF_IDB_BT_BUGLE_EXPESSION);
	m_pImageMap->AddImage(DEF_IDB_BT_BUGLE_COLOR_SET, RES_DEF_IDB_BT_BUGLE_COLOR_SET);
	...
	m_pImageMap->AddImage(DEF_IDB_BT_GIFT1, RES_DEF_IDB_BT_GIFT1);
	m_pImageMap->AddImage(DEF_IDB_BT_GIFT2, RES_DEF_IDB_BT_GIFT2);
	m_pImageMap->AddImage(DEF_IDB_BT_GIFT3, RES_DEF_IDB_BT_GIFT3);
	m_pImageMap->AddImage(DEF_IDB_BT_GIFT4, RES_DEF_IDB_BT_GIFT4);
	m_pImageMap->AddImage(DEF_IDB_BT_GIFT5, RES_DEF_IDB_BT_GIFT5);
	m_pImageMap->AddImage(DEF_IDB_BT_GIFT6, RES_DEF_IDB_BT_GIFT6);
	m_pImageMap->AddImage(DEF_IDB_BT_GIFT7, RES_DEF_IDB_BT_GIFT7);
	m_pImageMap->AddImage(DEF_IDB_BT_GIFT8, RES_DEF_IDB_BT_GIFT8);
	m_pImageMap->AddImage(DEF_IDB_BT_GIFT9, RES_DEF_IDB_BT_GIFT9);
	m_pImageMap->AddImage(DEF_IDB_BT_GIFT10, RES_DEF_IDB_BT_GIFT10);
	m_pImageMap->AddImage(DEF_IDB_BT_GIFT11, RES_DEF_IDB_BT_GIFT11);
	...
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY1, RES_DEF_IDB_BT_PROPERTY1);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY2, RES_DEF_IDB_BT_PROPERTY2);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY3, RES_DEF_IDB_BT_PROPERTY3);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY4, RES_DEF_IDB_BT_PROPERTY4);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY5, RES_DEF_IDB_BT_PROPERTY5);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY6, RES_DEF_IDB_BT_PROPERTY6);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY7, RES_DEF_IDB_BT_PROPERTY7);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY8, RES_DEF_IDB_BT_PROPERTY8);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY9, RES_DEF_IDB_BT_PROPERTY9);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY10, RES_DEF_IDB_BT_PROPERTY10);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY11, RES_DEF_IDB_BT_PROPERTY11);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY12, RES_DEF_IDB_BT_PROPERTY12);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY13, RES_DEF_IDB_BT_PROPERTY13);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY14, RES_DEF_IDB_BT_PROPERTY14);
	m_pImageMap->AddImage(DEF_IDB_BT_PROPERTY15, RES_DEF_IDB_BT_PROPERTY15);
	...
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FRAME_TO_L, RES_DEF_IDB_PROPERTY_FRAME_TO_L);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FRAME_TO_R, RES_DEF_IDB_PROPERTY_FRAME_TO_R);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FRAME_AREA_L, RES_DEF_IDB_PROPERTY_FRAME_AREA_L);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FRAME_AREA_M, RES_DEF_IDB_PROPERTY_FRAME_AREA_M);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FRAME_AREA_R, RES_DEF_IDB_PROPERTY_FRAME_AREA_R);
	...
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER1, RES_DEF_IDB_PROPERTY_FORMER1);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER2, RES_DEF_IDB_PROPERTY_FORMER2);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER3, RES_DEF_IDB_PROPERTY_FORMER3);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER4, RES_DEF_IDB_PROPERTY_FORMER4);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER5, RES_DEF_IDB_PROPERTY_FORMER5);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER6, RES_DEF_IDB_PROPERTY_FORMER6);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER7, RES_DEF_IDB_PROPERTY_FORMER7);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER8, RES_DEF_IDB_PROPERTY_FORMER8);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER9, RES_DEF_IDB_PROPERTY_FORMER9);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER10, RES_DEF_IDB_PROPERTY_FORMER10);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER11, RES_DEF_IDB_PROPERTY_FORMER11);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER12, RES_DEF_IDB_PROPERTY_FORMER12);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER13, RES_DEF_IDB_PROPERTY_FORMER13);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER14, RES_DEF_IDB_PROPERTY_FORMER14);
	m_pImageMap->AddImage(DEF_IDB_PROPERTY_FORMER15, RES_DEF_IDB_PROPERTY_FORMER15);
...
{	
	...
	m_pImageMap->AddImage(DEF_IDB_CHAT_BUGLE, RES_DEF_IDB_CHAT_BUGLE);
	m_pImageMap->AddImage(DEF_IDB_CHAT_GIFT1, RES_DEF_IDB_CHAT_GIFT1);
	m_pImageMap->AddImage(DEF_IDB_CHAT_GIFT2, RES_DEF_IDB_CHAT_GIFT2);
	m_pImageMap->AddImage(DEF_IDB_CHAT_GIFT3, RES_DEF_IDB_CHAT_GIFT3);
	m_pImageMap->AddImage(DEF_IDB_CHAT_GIFT4, RES_DEF_IDB_CHAT_GIFT4);
	m_pImageMap->AddImage(DEF_IDB_CHAT_GIFT5, RES_DEF_IDB_CHAT_GIFT5);
	m_pImageMap->AddImage(DEF_IDB_CHAT_GIFT6, RES_DEF_IDB_CHAT_GIFT6);
	m_pImageMap->AddImage(DEF_IDB_CHAT_GIFT7, RES_DEF_IDB_CHAT_GIFT7);
	m_pImageMap->AddImage(DEF_IDB_CHAT_GIFT8, RES_DEF_IDB_CHAT_GIFT8);
	m_pImageMap->AddImage(DEF_IDB_CHAT_GIFT9, RES_DEF_IDB_CHAT_GIFT9);
	m_pImageMap->AddImage(DEF_IDB_CHAT_GIFT10, RES_DEF_IDB_CHAT_GIFT10);
	m_pImageMap->AddImage(DEF_IDB_CHAT_GIFT11, RES_DEF_IDB_CHAT_GIFT11);
...
bool __cdecl CPlatformResource::GetGameFrameImage(tagGameFrameImage * GameFrameImage)
{
	...
	m_pImageMap->AddImage(DEF_IDB_GAME_CHAT_ML, RES_DEF_IDB_GAME_CHAT_ML);
	m_pImageMap->AddImage(DEF_IDB_GAME_CHAT_MR, RES_DEF_IDB_GAME_CHAT_MR);
	m_pImageMap->AddImage(DEF_IDB_GAME_CHAT_TL, RES_DEF_IDB_GAME_CHAT_TL);
	m_pImageMap->AddImage(DEF_IDB_GAME_CHAT_TM, RES_DEF_IDB_GAME_CHAT_TM);
	m_pImageMap->AddImage(DEF_IDB_GAME_CHAT_TR, RES_DEF_IDB_GAME_CHAT_TR);
	m_pImageMap->AddImage(DEF_IDB_GAME_CHAT_BL, RES_DEF_IDB_GAME_CHAT_BL);
	m_pImageMap->AddImage(DEF_IDB_GAME_CHAT_BM, RES_DEF_IDB_GAME_CHAT_BM);
	m_pImageMap->AddImage(DEF_IDB_GAME_CHAT_BR, RES_DEF_IDB_GAME_CHAT_BR);
	...
	m_pImageMap->AddImage(DEF_IDB_GAME_USER_LIST_ML, RES_DEF_IDB_GAME_USER_LIST_ML);
	m_pImageMap->AddImage(DEF_IDB_GAME_USER_LIST_MR, RES_DEF_IDB_GAME_USER_LIST_MR);
	m_pImageMap->AddImage(DEF_IDB_GAME_USER_LIST_TL, RES_DEF_IDB_GAME_USER_LIST_TL);
	m_pImageMap->AddImage(DEF_IDB_GAME_USER_LIST_TM, RES_DEF_IDB_GAME_USER_LIST_TM);
	m_pImageMap->AddImage(DEF_IDB_GAME_USER_LIST_TR, RES_DEF_IDB_GAME_USER_LIST_TR);
	m_pImageMap->AddImage(DEF_IDB_GAME_USER_LIST_BL, RES_DEF_IDB_GAME_USER_LIST_BL);
	m_pImageMap->AddImage(DEF_IDB_GAME_USER_LIST_BM, RES_DEF_IDB_GAME_USER_LIST_BM);
	m_pImageMap->AddImage(DEF_IDB_GAME_USER_LIST_BR, RES_DEF_IDB_GAME_USER_LIST_BR);
	...
	m_pImageMap->AddImage(DEF_IDB_BT_GAME_BUGLE, RES_DEF_IDB_BT_GAME_BUGLE);
	m_pImageMap->AddImage(DEF_IDB_BT_GAME_COLOR_SET, RES_DEF_IDB_BT_GAME_COLOR_SET);
	m_pImageMap->AddImage(DEF_IDB_BT_GAME_EXPESSION, RES_DEF_IDB_BT_GAME_EXPESSION);
	m_pImageMap->AddImage(DEF_IDB_BT_GAME_SEND_CHAT, RES_DEF_IDB_BT_GAME_SEND_CHAT);
	m_pImageMap->AddImage(DEF_IDB_BT_GAME_CLEAN_SCREEN, RES_DEF_IDB_BT_GAME_CLEAN_SCREEN);

	//切换按钮
	GameFrameImage->uBtShowUserList=DEF_IDB_GAME_SHOW_USER_LIST;
	GameFrameImage->uBtHideUserList=DEF_IDB_GAME_HIDE_USER_LIST;
	m_pImageMap->AddImage(DEF_IDB_GAME_SHOW_USER_LIST, RES_DEF_IDB_GAME_SHOW_USER_LIST);
	m_pImageMap->AddImage(DEF_IDB_GAME_HIDE_USER_LIST, RES_DEF_IDB_GAME_HIDE_USER_LIST);
	...
	m_pImageMap->AddImage(DEF_IDB_BT_GAME_EXCHANGE, RES_DEF_IDB_BT_GAME_EXCHANGE);
	m_pImageMap->AddImage(DEF_IDB_GAME_FEMALE_FACE, RES_DEF_IDB_GAME_FEMALE_FACE);
	m_pImageMap->AddImage(DEF_IDB_GAME_MALE_FACE, RES_DEF_IDB_GAME_MALE_FACE);
...
bool __cdecl CPlatformResource::GetVideoFrameImage(tagVideoFrameImage * VideoFrameImage)
{
	...
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_BIG_FLOWER, RES_DEF_IDB_BT_VIDEO_BIG_FLOWER);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_BIG_MORE, RES_DEF_IDB_BT_VIDEO_BIG_MORE);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_BIG_NOSEE, RES_DEF_IDB_BT_VIDEO_BIG_NOSEE);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_BIG_NOTALK, RES_DEF_IDB_BT_VIDEO_BIG_NOTALK);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_BIG_RESORE, RES_DEF_IDB_BT_VIDEO_BIG_RESORE);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_BIG_SEE, RES_DEF_IDB_BT_VIDEO_BIG_SEE);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_BIG_TALK, RES_DEF_IDB_BT_VIDEO_BIG_TALK);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_SMALL_FLOWER, RES_DEF_IDB_BT_VIDEO_SMALL_FLOWER);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_SMALL_MORE, RES_DEF_IDB_BT_VIDEO_SMALL_MORE);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_SMALL_NOSEE, RES_DEF_IDB_BT_VIDEO_SMALL_NOSEE);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_SMALL_NOTALK, RES_DEF_IDB_BT_VIDEO_SMALL_NOTALK);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_SMALL_RESORE, RES_DEF_IDB_BT_VIDEO_SMALL_RESORE);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_SMALL_SEE, RES_DEF_IDB_BT_VIDEO_SMALL_SEE);
	m_pImageMap->AddImage(DEF_IDB_BT_VIDEO_SMALL_TALK, RES_DEF_IDB_BT_VIDEO_SMALL_TALK);
	...
	m_pImageMap->AddImage(DEF_IDB_VIDEO_LARGE_FEMALE, RES_DEF_IDB_VIDEO_LARGE_FEMALE);
	m_pImageMap->AddImage(DEF_IDB_VIDEO_LARGE_FRAME, RES_DEF_IDB_VIDEO_LARGE_FRAME);
	m_pImageMap->AddImage(DEF_IDB_VIDEO_LARGE_MALE, RES_DEF_IDB_VIDEO_LARGE_MALE);
	m_pImageMap->AddImage(DEF_IDB_VIDEO_LARGE_PHOTO, RES_DEF_IDB_VIDEO_LARGE_PHOTO);
	m_pImageMap->AddImage(DEF_IDB_VIDEO_LARGE_VOLUME, RES_DEF_IDB_VIDEO_LARGE_VOLUME);
	m_pImageMap->AddImage(DEF_IDB_VIDEO_LARGE_VOLUME_EX, RES_DEF_IDB_VIDEO_LARGE_VOLUME_EX);
	m_pImageMap->AddImage(DEF_IDB_VIDEO_SMALL_FEMALE, RES_DEF_IDB_VIDEO_SMALL_FEMALE);
	m_pImageMap->AddImage(DEF_IDB_VIDEO_SMALL_FRAME, RES_DEF_IDB_VIDEO_SMALL_FRAME);
	m_pImageMap->AddImage(DEF_IDB_VIDEO_SMALL_MALE, RES_DEF_IDB_VIDEO_SMALL_MALE);
	m_pImageMap->AddImage(DEF_IDB_VIDEO_SMALL_PHOTO, RES_DEF_IDB_VIDEO_SMALL_PHOTO);
	m_pImageMap->AddImage(DEF_IDB_VIDEO_SMALL_VOLUME, RES_DEF_IDB_VIDEO_SMALL_VOLUME);
	m_pImageMap->AddImage(DEF_IDB_VIDEO_SMALL_VOLUME_EX, RES_DEF_IDB_VIDEO_SMALL_VOLUME_EX);
	return true;
}
...
bool __cdecl CPlatformResource::GetPropertyMenuImage(tagPropertyMenuImage * PropertyMenuImage)
{
	...
	m_pImageMap->AddImage(DEF_IDB_MENU_GIFT_1, RES_DEF_IDB_MENU_GIFT_1);
	m_pImageMap->AddImage(DEF_IDB_MENU_GIFT_2, RES_DEF_IDB_MENU_GIFT_2);
	m_pImageMap->AddImage(DEF_IDB_MENU_GIFT_3, RES_DEF_IDB_MENU_GIFT_3);
	m_pImageMap->AddImage(DEF_IDB_MENU_GIFT_4, RES_DEF_IDB_MENU_GIFT_4);
	m_pImageMap->AddImage(DEF_IDB_MENU_GIFT_5, RES_DEF_IDB_MENU_GIFT_5);
	m_pImageMap->AddImage(DEF_IDB_MENU_GIFT_6, RES_DEF_IDB_MENU_GIFT_6);
	m_pImageMap->AddImage(DEF_IDB_MENU_GIFT_7, RES_DEF_IDB_MENU_GIFT_7);
	m_pImageMap->AddImage(DEF_IDB_MENU_GIFT_8, RES_DEF_IDB_MENU_GIFT_8);
	m_pImageMap->AddImage(DEF_IDB_MENU_GIFT_9, RES_DEF_IDB_MENU_GIFT_9);
	m_pImageMap->AddImage(DEF_IDB_MENU_GIFT_10, RES_DEF_IDB_MENU_GIFT_10);
	m_pImageMap->AddImage(DEF_IDB_MENU_GIFT_11, RES_DEF_IDB_MENU_GIFT_11);
...
CImageMap* __cdecl CPlatformResource::GetImageMap(void)
{
	return m_pImageMap;
}
