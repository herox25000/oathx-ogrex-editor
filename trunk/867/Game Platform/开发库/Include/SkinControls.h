...
//模块定义
#ifdef _DEBUG
	#define SKIN_CONTROL_DLL_NAME	TEXT("plugin_ui_d.dll")			//组件 DLL 名字
#else
	#define SKIN_CONTROL_DLL_NAME	TEXT("plugin_ui.dll")			//组件 DLL 名字
#endif
//////////////////////////////////////////////////////////////////////////
...
class SKIN_CONTROL_CLASS CImageMap
{
public:

	void					AddImage(UINT uiImage, CString strResPath);

	bool					GetImageInfo(UINT uiImage, CString &strResPath);

	void					Clear(void);

protected:

	std::map<UINT, CString>		m_mapImages;
};
...
public:
	//获取信息
	virtual bool __cdecl GetResourceInfo(tagSkinEditResource & SkinEditResource, CImageMap *pImageMap)=NULL;
	//获取信息
	virtual bool __cdecl GetResourceInfo(tagSkinDialogResource & SkinDialogResource, CImageMap *pImageMap)=NULL;
	//获取信息
	virtual bool __cdecl GetResourceInfo(tagSkinButtonResource & SkinButtonResource, CImageMap *pImageMap)=NULL;
	//获取信息
	virtual bool __cdecl GetResourceInfo(tagSkinSplitterResource & SkinSplitterResource, CImageMap *pImageMap)=NULL;
	//获取信息
	virtual bool __cdecl GetResourceInfo(tagSkinListCtrlResource & SkinListCtrlResource, CImageMap *pImageMap)=NULL;
	//获取信息
	virtual bool __cdecl GetResourceInfo(tagSkinHyperLinkResource & SkinHyperLinkResource, CImageMap *pImageMap)=NULL;
};
