...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("Ox100.EXE"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("Ox100Server.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
