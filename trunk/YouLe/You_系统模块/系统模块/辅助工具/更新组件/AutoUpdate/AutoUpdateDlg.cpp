...
//#endif
	...
	//读取配置参数
	strSiteURL = AfxGetApp()->GetProfileString(_T("Download"), _T("site1"), _T("127.0.0.1"));
...
void CAutoUpdateDlg::OnStatusCallback(ULONG ulProgress, ULONG ulProgressMax, ULONG ulStatusCode, LPCTSTR pszStatusText)
{
	...
	case DMS_ERROR:
		{
			CString strError = AfxGetApp()->GetProfileString(_T("messages"), _T("ErrorMsg"), _T("更新失败，请到127.0.0.1下载最新版本"));
