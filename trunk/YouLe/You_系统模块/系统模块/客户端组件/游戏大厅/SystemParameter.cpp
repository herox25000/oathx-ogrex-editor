...
CSystemParameter::CSystemParameter(void)
{
	//全局配置
...
//加载设置
void CSystemParameter::LoadOptionParameter()
{
	//变量定义
	CWinApp * pApp=AfxGetApp();
	...
	//消息设置
	m_bUseBoss = pApp->GetProfileInt(REG_GLOBAL_OPTIONS,TEXT("UseBoss"),m_bUseBoss)?true:false;
...
//保存设置
void CSystemParameter::SaveOptionParameter()
{
	//变量定义
	CWinApp * pApp=AfxGetApp();
...
//游戏配置
CGameOption * CSystemParameter::GetGameOption(CListKind * pListKind)
{
	//获取参数
...
//房间设置
CServerOption * CSystemParameter::GetServerOption(CListServer * pListServer)
{
	//获取参数
