...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtFillGrantRate" runat="server" CssClass="text" onkeyup="if(isNaN(value))execCommand('undo');"  MaxLength="3"></asp:TextBox>(单位%)
                 &nbsp;
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtBalanceRate" runat="server" CssClass="text" onkeyup="if(isNaN(value))execCommand('undo');"  MaxLength="3"></asp:TextBox>(单位%)
                &nbsp;
