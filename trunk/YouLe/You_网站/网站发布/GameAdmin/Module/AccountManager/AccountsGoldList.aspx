        ...
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="ddlSearchType" runat="server">
                    ...
                    <asp:ListItem Value="3">按用户金币大于等于</asp:ListItem>
                    <asp:ListItem Value="4">按用户金币小于等于</asp:ListItem>
                    <asp:ListItem Value="5">按银行金币大于等于</asp:ListItem>
                    <asp:ListItem Value="6">按银行金币小于等于</asp:ListItem>
                </asp:DropDownList>
