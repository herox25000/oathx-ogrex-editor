<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayDay.aspx.cs" Inherits="Game.Web.Pay.PayDay" %>
...
<!--左边部分结束-->
    ...
    <div id="content">
		...
		<form name="fmStep1" id="fmStep1" runat="server" action="/Pay/PayDayCreatOrder.aspx" target="_self">
		<div class="content">
			...
			<p style="display:none;">
		  		<span class="mtop10">支持的银行：</span>
		  		<label>
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="cmd" checked="checked" />招商银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="icbc" />工商银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="ccb" />建设银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="abc" />农业银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="boc" />中国银行</span>
					 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="pingan" />平安银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="cib" />兴业银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="cmbc" />民生银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="spdb" />浦发银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="comm" />交通银行</span> 
					
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="bos" />上海银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="citic" />中信银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="hxb" />华夏银行</span> 		
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="hccb" />杭州银行</span>
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="gzcb" />广州银行</span>
					
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="nbcb" />宁波银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="njcb" />南京银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="cbhb" />渤海银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="hkbchina" />汉口银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="qicbc" />工商企业银行</span> 
					
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="qccb" />建设企业银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="qabc" />农业企业银行</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="sde" />顺德农信社</span> 
					<span style="width:135px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="gdb" />广东发展银行</span> 
					<span style="width:160px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="ydxh" />尧都信用合作联社</span> 
					
					<span style="width:190px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="shrcb" />上海市农村商业银行</span> 
					<span style="width:190px; margin-left:0px; text-align:left;"><input name="rdBank" type="radio" value="gnxs" />广州市农村信用合作社</span>
				</label>
		  	</p>			
        </div>
		<div class="clear"></div>
		<div class="content_btn">
            <input type="submit" value="确定" Class="btnL" id="btnPay"/>
        </div>  
