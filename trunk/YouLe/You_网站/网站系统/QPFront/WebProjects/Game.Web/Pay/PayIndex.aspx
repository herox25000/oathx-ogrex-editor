...
<!--左边部分结束-->
    ...
    <div id="content">
        ...
        <div class="payRechargeCard">
            <span><a href="/Pay/PayMobile.aspx?type=1" class="card6" hideFocus="ture"></a></span>
            <label>支持全国通用的神州行手机充值卡（卡号17位，密码18位）。</label>
            <a href="/Pay/PayMobile.aspx?type=1" class="btnRecharge" hideFocus="ture"></a>
            <div class="clear"></div>
        </div>
        <div class="payRechargeTitle" style="text-align:left; padding-top:5px;">其他充值方式</div>       
        <div class="payRechargeCard">
            <span><a href="/Pay/PayMobile.aspx?type=2" class="card5" hideFocus="ture"></a></span>
            <label>支持全国通用的联通手机充值卡（卡号15位，密码19位）。</label>
            <a href="/Pay/PayMobile.aspx?type=2" class="btnRecharge" hideFocus="ture"></a>
            <div class="clear"></div>
        </div>
        <div class="payRechargeCard">
			<span><a href="/Pay/PayMobile.aspx?type=3" class="card7" hideFocus="ture"></a></span>
			<label>支持全国通用的电信手机充值卡（卡号19位，密码18位）。</label>
			<a href="/Pay/PayMobile.aspx?type=3" class="btnRecharge" hideFocus="ture"></a>
			<div class="clear"></div>
		</div>
        <div class="payRechargeCard">
        ...
        <div class="payRechargeCard">
			<span><a href="/Pay/PayGame.aspx?type=1" class="card8" hideFocus="ture"></a></span>
			<label>支持全国通用的盛大一卡通 （卡号 15 位，密码 8 位）。 </label>
			<a href="/Pay/PayGame.aspx?type=1" class="btnRecharge" hideFocus="ture"></a>
			<div class="clear"></div>
		</div>
        <div class="payRechargeCard">
			<span><a href="/Pay/PayGame.aspx?type=3" class="card3" hideFocus="ture"></a></span>
			<label>支持全国通用的网易一卡通 （卡号 13 位，密码 9 位）。 </label>
			<a href="/Pay/PayGame.aspx?type=3" class="btnRecharge" hideFocus="ture"></a>
			<div class="clear"></div>
		</div>
		<div class="payRechargeCard">
		    <span><a href="/Pay/PayGame.aspx?type=2" class="card9" hideFocus="ture"></a></span>
		    <label>支持全国通用的征途游戏卡 （卡号 16 位，密码 8 位）。 </label>
		    <a href="/Pay/PayGame.aspx?type=2" class="btnRecharge" hideFocus="ture"></a>
		    <div class="clear"></div>
	    </div>
		<div id="moreType" style="display:none">
		    <div class="payRechargeCard">
			    <span><a href="/Pay/PayGame.aspx?type=4" class="card10" hideFocus="ture"></a></span>
			    <label>支持全国通用的搜狐一卡通 （卡号 20 位，密码 12 位）。</label>
			    <a href="/Pay/PayGame.aspx?type=4" class="btnRecharge" hideFocus="ture"></a>
			    <div class="clear"></div>
		    </div>
		    <div class="payRechargeCard">
			    <span><a href="/Pay/PayGame.aspx?type=5" class="card11" hideFocus="ture"></a></span>
			    <label>支持全国通用的完美一卡通 （卡号 10 位，密码 15 位）。</label>
			    <a href="/Pay/PayGame.aspx?type=5" class="btnRecharge" hideFocus="ture"></a>
			    <div class="clear"></div>
		    </div>
		</div>
