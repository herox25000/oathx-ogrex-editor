    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="txtCardGold" runat="server" MaxLength="8" onkeyup="if(isNaN(value))execCommand('undo');" CssClass="text"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="txtMemberDays" runat="server" MaxLength="7" onkeyup="if(isNaN(value))execCommand('undo');" CssClass="text"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
