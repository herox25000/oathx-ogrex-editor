...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtMaxDatePresent" runat="server" CssClass="text" onkeyup="if(isNaN(value))execCommand('undo');" Text="0" MaxLength="10"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
            ...
            <td>
                <asp:TextBox ID="txtMaxPresent" runat="server" CssClass="text" onkeyup="if(isNaN(value))execCommand('undo');" Text="0" MaxLength="10"></asp:TextBox>
            </td>
        </tr>
    </table>
    </asp:PlaceHolder>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtCellPlayPresnet" runat="server" CssClass="text" onkeyup="if(isNaN(value))execCommand('undo');" Text="0" MaxLength="10"></asp:TextBox>
                &nbsp;&nbsp;
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtCellOnlinePresent" runat="server" CssClass="text" onkeyup="if(isNaN(value))execCommand('undo');" Text="0" MaxLength="10"></asp:TextBox>
                &nbsp;&nbsp;
