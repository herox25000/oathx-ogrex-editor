...
namespace Game.Web.Module.AppManager
{
    public partial class DataBaseInfoList : AdminPage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string strQuery = "WHERE DBInfoID in (" + Checkbox_Value + ")";
            try
            {
                aidePlatformFacade.DeleteDataBase(strQuery);
                ShowInfo("删除成功");
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = aidePlatformFacade.GetDataBaseList(anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby);
