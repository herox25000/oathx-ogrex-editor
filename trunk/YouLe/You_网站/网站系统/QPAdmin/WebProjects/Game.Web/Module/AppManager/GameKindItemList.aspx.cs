...
namespace Game.Web.Module.AppManager
{
    public partial class GameKindItemList : AdminPage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                aidePlatformFacade.DeleteGameKindItem(strQuery);
                ShowInfo("删除成功");
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = aidePlatformFacade.GetGameKindItemList(anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby);
