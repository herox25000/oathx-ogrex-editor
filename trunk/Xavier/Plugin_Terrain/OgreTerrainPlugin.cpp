...
namespace Ogre
{
	...
	{
		System::getSingletonPtr()->registerServerFactory(new TerrainGlobalOptionServerFactory());
	...
	{
		System::getSingletonPtr()->unregisterServerFactory(TerrainGlobalOptionServerFactory::FactoryTypeName);
