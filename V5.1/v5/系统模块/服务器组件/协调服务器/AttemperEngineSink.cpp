	...
	case SUB_CS_C_REGISTER_SERVER:	//注册房间
		{
			...
			GameServer.lServerScore = pRegisterServer->lServerScore;
			GameServer.lMinServerScore = pRegisterServer->lMinServerScore;
	...
	case SUB_CS_C_SERVER_MODIFY:	//房间修改
		{
			...
			if (pGlobalServerItem!=NULL)
			{
				...
				pGlobalServerItem->m_GameServer.lServerScore = pServerModify->lServerScore;
				pGlobalServerItem->m_GameServer.lMinServerScore = pServerModify->lMinServerScore;
				...
				ServerModify.lServerScore=pServerModify->lServerScore;
				ServerModify.lMinServerScore=pServerModify->lMinServerScore;
