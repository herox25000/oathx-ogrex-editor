...
#define	BILL_R						6									//广告右宽
#define	BILL_B						118  								//广告下高

//面板偏移
#define PANEL_T						5									//面板上高
#define PANEL_L						7									//面板左宽
#define PANEL_R						5									//面板右宽
#define PANEL_B						2									//面板下高

//控件标示
#define IDC_WEB_PUBLICIZE			100									//浏览控件
#define IDC_BT_USER_MEDAL			101									//兑换奖牌
#define IDC_BT_LOVE_LINESS			102									//兑换魅力
#define IDC_CUSTOM_PANEL            104                                 //自定义面板
