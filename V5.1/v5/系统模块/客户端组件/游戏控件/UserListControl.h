...
//默认颜色
#define COLOR_SELECT_TX				RGB(255,255,151)					//字体颜色
#define COLOR_SELECT_BK				RGB(1,83,120)						//背景颜色
#define COLOR_NORMAL_TX				RGB(192,192,192)					//字体颜色
#define COLOR_NORMAL_BK				RGB(1,83,120)					    //背景颜色

//默认颜色
#define COLOR_MYSELF_TX				RGB(255,255,255)					//字体颜色
#define COLOR_MYSELF_BK				RGB(1,83,120)				    	//背景颜色
#define COLOR_MASTER_TX				RGB(251,72,68)						//字体颜色
#define COLOR_MASTER_BK				RGB(1,83,120)					    //背景颜色
#define COLOR_MEMBER_TX				RGB(251,72,68)						//字体颜色
#define COLOR_MEMBER_BK				RGB(1,83,120)					    //背景颜色
