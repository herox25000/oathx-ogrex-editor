...
#define SERVICE_MEMBER_PAYMENT		6									//账号充值
...
#define SERVICE_MEMBER_INFO			14									//账号介绍
...
//浏览服务
class CDlgServiceWebBrowse : public  CSkinDialog
{
	//服务变量
protected:
	TCHAR							m_szCaption[128];					//浏览标题
	TCHAR							m_szBrowseAddr[128];				//浏览网址
...
public:
	//构造函数
	CDlgServiceWebBrowse(LPCTSTR szCaption,LPCTSTR  szBrowseAddr);
	//析构函数
	virtual ~CDlgServiceWebBrowse();
