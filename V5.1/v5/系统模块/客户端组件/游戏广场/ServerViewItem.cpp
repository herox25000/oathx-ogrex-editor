...
#define SPLITTER_CX					6									//拆分宽度
#define TABLE_BUTTON_SX				8									//按钮空隙
...
VOID CServerViewItem::TrackUserItemMenu(IClientUserItem * pIClientUserItem)
{
	...
	//if (wTableID!=INVALID_TABLE)
	//{
	//	_sntprintf(szMenuString,CountArray(szMenuString),TEXT("正在游戏桌"));
	...
	{
		_sntprintf(szMenuString,CountArray(szMenuString),TEXT("金币：") SCORE_STRING TEXT(" 胜率：%5.2f%%  逃跑率：%5.2f%%"),
