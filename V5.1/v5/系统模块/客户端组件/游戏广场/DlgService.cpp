...
//浏览服务
#define IDC_WEB_BOROSER             200                                 //浏览控件            
...
BOOL CDlgService::OnInitDialog()
{
	...
	m_DlgServiceBrowser1.InitService(5,TEXT("账号充值"),szOpenAddr);
	...
	m_DlgServiceBrowser2.InitService(6,TEXT("游戏记录"),szOpenAddr);
	...
	m_DlgServiceBrowser3.InitService(7,TEXT("充值记录"),szOpenAddr);
