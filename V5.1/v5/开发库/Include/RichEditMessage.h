...
#define COLOR_EVENT					RGB(243,140,5)						//事件消息
#define COLOR_NORMAL				RGB(255,255,151)					//普通消息
#define COLOR_SYSTEM_STRING			RGB(253,71,68)					    //系统消息

//私聊颜色
#define COLOR_USER					RGB(255,0,0)						//对方颜色
