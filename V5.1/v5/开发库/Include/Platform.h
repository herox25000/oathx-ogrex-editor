...
//平台常量
const TCHAR	szProduct[]=TEXT("V5游戏中心");								//产品名字
const TCHAR szPlazaClass[]=TEXT("V5GamePlaza");							//广场类名
const TCHAR szProductKey[]=TEXT("V5Game");							    //产品主键

//地址定义
const TCHAR szCookieUrl[]=TEXT("http://v5dv.com");						//记录地址
const TCHAR szLogonServer[]=TEXT("www.v5dv.com");						//登录地址
const TCHAR szPlatformLink[]=TEXT("http://www.v5dv.com/");				//平台网站
...
//授权信息
const TCHAR szCompilation[]=TEXT("A251BCAB-B295-4AB7-9FD5-5FE438C7E298");
